...
{
    /// <inheritdoc />
    public partial class EvaTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HistoricalContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CulturalContent = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    TranslationKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MediaDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    MainIngredientImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Story = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegionCulturalImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegionCulturalImages_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegionHistoricalImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegionHistoricalImages_Regions_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Regions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Story = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Benfits = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_TranslationKey",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_TranslationKey",
                table: "Ingredients",
                column: "TranslationKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_TranslationKey",
                table: "Products",
                column: "TranslationKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegionCulturalImages_RegionId",
                table: "RegionCulturalImages",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_RegionHistoricalImages_RegionId",
                table: "RegionHistoricalImages",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_Regions_TranslationKey",
                table: "Regions",
                column: "TranslationKey",
                unique: true);
